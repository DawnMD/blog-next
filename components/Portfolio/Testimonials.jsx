	...
	return (
		<Section title='Testimonials'>
			<figure className='relative flex flex-col gap-4 px-6 py-3'>
				<blockquote className='font-serif italic before:absolute before:top-0 before:-left-2 before:text-6xl before:content-quote'>
					<p className='text-3xl font-bold tracking-wide max-w-7xl'>
