...
const Nav = (props) => {
	...
	return (
		<>
			<header className='sticky top-0 left-0 z-10 flex items-center justify-between w-full p-4 text-lg font-medium bg-gray-100 shadow-xl bg-opacity-95 md:text-xl dark:bg-gray-900'>
